...
|___/ \_| \_\____/  \_____/\___/ \___/|_|\_\\__,_| .__ / 
                                                 ...
                                                 |_|     
"""
            os.system('curl http://api.hackertarget.com/dnslookup/?q='
                      + d3)
            print ''
            quit()
        elif choice == 0:
...
|__|__|___|\_/|___|_| |___|___|  |____/|_|___|_____|
	  ...
	  """
            os.system('curl https://api.hackertarget.com/reversedns/?q='
                       + d3)
            print ''
            quit()
        elif choice == 5:
